...
python /lfs/h2/emc/ptmp/emc.lam/Shun.Liu/blending/plt_rrfs_nc_restart.py
#python /lfs/h2/emc/ptmp/emc.lam/Shun.Liu/rrfs_plt_restart/plt_rrfs_nc_restart_surface.py
