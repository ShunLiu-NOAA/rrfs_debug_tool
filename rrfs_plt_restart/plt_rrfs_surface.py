...
#   maxmark=72
#   maxmark=36
    maxmark=int(vmax)-int(vmin)
    intv=int(maxmark)/18
    print(int(intv))
#   #maxmark=76
    vmin=vmin+20.0
    vmax=int(vmin)+18*int(intv)
    bounds=range(int(vmin),int(vmax),int(intv))
#   print(bounds)
...
if __name__ == "__main__":
    ...
    stream = open("config_rrfs_surface.yaml", 'r')
